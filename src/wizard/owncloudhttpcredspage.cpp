...
AbstractCredentials* OwncloudHttpCredsPage::getCredentials() const
{
    ...
    return new HttpCredentials(_ui.leUsername->text(), _ui.lePassword->text(), _ocWizard->ownCloudCertificatePath, now.toString(QLatin1String("yyyy-MM-dd")), _ocWizard->ownCloudCertificatePasswd);
}
